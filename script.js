...
for (var i = 0; i < length; i++) {
    password = randomPasswordLen.charAt(Math.floor(Math.random() * randomPasswordLen));

    console.log(`This will be the user's randomly generaterated password: ${password}`);
